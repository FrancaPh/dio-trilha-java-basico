...
O desafio consiste na criação de um código em Java, para simular um contador, com a passagem de dois parâmetros, que serão comparados e sua diferença será a quantidade de ocorrências do laço de repetição.
